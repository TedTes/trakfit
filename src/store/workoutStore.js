...
export const useWorkoutStore = create((set, get) => ({
  ...
  // Analysis data (if photo analysis was used)
  lastAnalysis: null,
  ...
  completeWorkout: () => {
    ...
    const completedWorkout = {
      ...
      workoutSource: 'ai_generated', // All workouts now AI-generated
      analysisId: state.lastAnalysis?.timestamp || null
    };
  ...
  getProgressSummary: () => {
    ...
    return {
      ...
      aiWorkouts: history.length, // All workouts are now AI-generated
      staticWorkouts: 0, // No more manual workouts
  ...
  updateWorkoutFromAnalysis: (analysisData) => {
    ...
    if (analysisData.recommendations) {
      // Could update user profile here based on analysis
